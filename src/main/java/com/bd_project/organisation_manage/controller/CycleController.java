...
public class CycleController {
	...
	@PostMapping("/create/{gradeId}/{sectionId}/{sectionName}")
	public String create(@PathVariable Integer gradeId, @PathVariable Integer sectionId, @PathVariable String sectionName)
    {
		Cycle cycle = cycleservice.createCycle(gradeId, sectionId, sectionName);
	...
	@PutMapping("/update/{cycleId}/{gradeId}/{sectionId}/{sectionName}")
    public String update(@PathVariable Integer cycleId, @PathVariable Integer gradeId, @PathVariable Integer sectionId, @PathVariable String sectionName)
    {
		Cycle cycle = cycleservice.modifyCycle(cycleId, gradeId, sectionId, sectionName);

        if(cycle == null)
            return "";

        cycleservice.modifyCycle(cycleId, gradeId, sectionId, sectionName);
